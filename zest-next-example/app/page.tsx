          ...
          <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16 sm:py-24">
            <div className="text-center">
              ...
              <p className="mt-6 max-w-2xl mx-auto text-xl text-gray-600 dark:text-gray-300">
                Zest is a Pinia-like state management library for React, offering fine-grained reactivity,
              ...
              <div className="mt-8 flex gap-4 justify-center">
                ...
                <a
                  href="https://github.com/yourusername/zest"
              ...
              <div className="rounded-xl bg-gray-900 dark:bg-gray-800 overflow-hidden shadow-lg">
                ...
                <div className="p-4 overflow-x-auto">
                  <pre className="text-sm text-gray-100 font-mono">
                    <code>
                      {`import { defineZestStore } from 'zest';
...
function Counter() {
  const counter = useZestStore(useCounterStore);
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="text-center mb-12">
            ...
            <p className="mt-2 text-3xl font-extrabold text-gray-900 dark:text-white sm:text-4xl">
              Explore Zest's Capabilities
            </p>
            <p className="mt-4 max-w-2xl mx-auto text-xl text-gray-600 dark:text-gray-300">
              See Zest in action with these interactive demos showcasing key features.
            </p>
          </div>
          ...
          <div className="grid gap-8 lg:grid-cols-2">
            ...
            <div className="bg-white dark:bg-gray-900 rounded-xl shadow-xl overflow-hidden transform transition-all hover:scale-[1.01]">
              ...
              <div className="px-6 py-4 bg-gray-50 dark:bg-gray-800">
                <p className="text-sm text-gray-600 dark:text-gray-400">
                  This feature and its store are loaded on-demand using React.lazy and dynamic imports, demonstrating Zest's compatibility with code splitting.
                </p>
              </div>
            </div>
          </div>
      ...
      <div className="bg-indigo-700 dark:bg-indigo-900">
        <div className="max-w-2xl mx-auto text-center py-16 px-4 sm:py-20 sm:px-6 lg:px-8">
          <h2 className="text-3xl font-extrabold text-white sm:text-4xl">
            <span className="block">Ready to try Zest?</span>
          </h2>
          <p className="mt-4 text-lg leading-6 text-indigo-200">
            Get started with Zest today and experience a simpler, more intuitive approach to state management in React.
          </p>
