...
export const metadata: Metadata = {
  title: "Zest - React State Management Library",
              ...
              <div className="flex justify-between h-16">
                <div className="flex">
                  <div className="flex-shrink-0 flex items-center">
                    ...
                    <span className="ml-2 text-xl font-semibold">Zest</span>
                ...
                <div className="flex items-center">
                  <a href="https://github.com/yourusername/zest" target="_blank" rel="noopener noreferrer" className="text-gray-500 hover:text-gray-700 dark:text-gray-400 dark:hover:text-gray-200 p-2">
            ...
            <div className="max-w-7xl mx-auto py-8 px-4 sm:px-6 md:flex md:items-center md:justify-between lg:px-8">
              ...
              <div className="mt-8 md:mt-0 md:order-1">
                <p className="text-center text-base text-gray-400 dark:text-gray-500">
                  &copy; 2023 Zest. All rights reserved.
                </p>
              </div>
            </div>
          </footer>
